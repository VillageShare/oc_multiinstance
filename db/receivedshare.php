...
class ReceivedShare extends Entity {
	...
	public function __construct($shareID, $shareType, $shareWith, $uidOwner, $itemType, $fileSourceStorage, $fileSourcePath, $fileTarget, $permissions, $stime, $token, $destinationLocation, $sendingLocation, $queueType, $state, $updatedAt){
