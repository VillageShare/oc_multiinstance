...
class QueuedGroupUserMapper extends Mapper {
	...
	public function __construct($api){
		parent::__construct($api, 'multiinstance_queued_groupuser');
	}
	...
	public function find($gid, $uid, $addedAt, $destinationLocation, $status){
		...
		return new QueuedGroupUser($row);
	...
	public function findAll(){
		...
		while($row = $result->fetchRow()){
			$entity = new QueuedGroupUser($row);
	 ...
	 */
	public function delete(Entity $queuedGroupUser){
