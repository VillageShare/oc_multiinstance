...
class QueuedFileCache extends Entity {
	...
	public function __construct($storage, $path, $pathHash, $parentStorage, $parentPath, $name, $mimetype, $mimepart, $size, $mtime, $encrypted, $etag, $permissions, $addedAt, $destinationLocation){
