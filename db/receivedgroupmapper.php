...
class ReceivedGroupMapper extends Mapper {
	...
	public function __construct($api){
		parent::__construct($api, 'multiinstance_received_groups');
	}
	 ...
	 */
	public function save($receivedGroup){
		if ($this->exists($receivedGroup->getGid(), $receivedGroup->getAddedAt(), $receivedGroup->getDestinationLocation())) {
